         ...
         <div className='md:grid md:grid-cols-2 md:gap-10 xl:grid-cols-3'>
            {
                project.map((item) => {
                    ...
                    return (
                    <div key={id} className='my-10 md:my-0 md:z-0 thecard shadow-md shadow-blue-500 pb-3 rounded-sm z-0'>
                            <Link to={link} className=''>
                                 <img src={img} alt={name} className=' rounded-tr-sm rounded-tl-sm'/>                                      
                            </Link>
