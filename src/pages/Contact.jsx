    ...
    >
      <div className="px-7 contact flex flex-col justify-center items-center  h-screen bg-white ">
        <form
          ...
          className="shadow-md shadow-blue-500 p-5 rounded-md w-full mt-16 md:w-3/5 lg:w-2/5"
        >
          <h1 className="flex flex-row items-center justify-center">
            {" "}
            <img src={Logo} className="w-36 h-24" alt="My logo" />
          </h1>
          <div className="input">
            <input
              type="text"
          ...
          <p className="text-center py-5">
            Send me a direct email through{" "}
