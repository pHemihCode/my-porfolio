    ...
    <div>
      <div className="navbar z-10 h-20 w-screen fixed top-0 md:flex md:flex-row md:items-center md:justify-between md:pl-5 md:pr-10 md:z-10 lg:pl-10 lg:pr-16 xl:pr-24">
        ...
        <nav
          ...
          className={
            hamburger
              ? "hidden md:flex md:space-x-6 md:activelink xl:space-x-10 xl:text-lg"
              : "show bg-blue-400 z-10"
          }
        >
          <NavLink to="/">
            {" "}
            <AiOutlineHome className="i md:hidden md:active" />
            Home
          </NavLink>
          <NavLink to="/about">
            <BsPersonCheck className="i md:hidden" />
            About
          </NavLink>
          <NavLink to="/projects">
            <AiOutlineProject className="i md:hidden" />
            Projects
          </NavLink>
          <NavLink to="/services">
            <MdOutlineMiscellaneousServices className="i md:hidden" />
            Services
          </NavLink>
          <NavLink to="/contact">
            <RiContactsLine className="i md:hidden" />
            Contact
          </NavLink>
        </nav>
