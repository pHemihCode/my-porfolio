...
function NavBar() {
  ...
  return (
     <div>
       <div className="navbar h-20 w-screen fixed top-0 md:flex md:flex-row md:items-center md:justify-between md:pl-5 md:pr-10 md:z-10 lg:pl-10 lg:pr-16 xl:pr-24">
       <div className="logo w-32 h-32 md:h-fit">
           <Link to='/'>
                <img src={Logo} alt='pHoenix' />
           </Link>
       </div>
        <nav onClick={handleClick} className={hamburger ? 'hidden md:flex md:space-x-6 md:activelink xl:space-x-10 xl:text-lg' : 'show bg-blue-400'}>
